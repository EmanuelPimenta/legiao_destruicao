...
var coffee_box = preload("res://Alterções caua/ENERGIA.png")
var health_box = preload("res://Alterções caua/CORAÇÃO.png")
var gun_box = preload("res://Alterções caua/ARMA_VER2.png")
